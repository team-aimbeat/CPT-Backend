...
class PostController extends Controller
{
    ...
    public function store(PostRequest $request)
    {
        ...
        if( $post->video_type == 'upload_video' ) {
            storeMediaFile($post,$request->post_video, 'post_video');
        }
    ...
    public function update(PostRequest $request, $id)
    {
        ...
        if( $post->video_type == 'upload_video' ) {
            if (isset($request->post_video) && $request->post_video != null) {
                $post->clearMediaCollection('post_video');
                $post->addMediaFromRequest('post_video')->toMediaCollection('post_video');
            }
        }
    ...
    public function destroy($id)
    {
        if(env('APP_DEMO')){
            ...
            return redirect()->route('post.index')->withErrors($message);
        }
