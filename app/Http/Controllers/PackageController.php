...
class PackageController extends Controller
{
    ...
    public function index(PackageDataTable $dataTable)
    {
        ...
        $headerAction = $auth_user->can('package-add') ? '<a href="'.route('packages.create').'" class="btn btn-sm btn-primary" role="button">'.__('message.add_form_title', [ 'form' => __('message.package')]).'</a>' : '';
    ...
    public function store(PackageRequest $request)
    {
        ...
        return redirect()->route('packages.index')->withSuccess(__('message.save_form', ['form' => __('message.package')]));
    }
    ...
    public function update(PackageRequest $request, $id)
    {
        ...
        if(auth()->check()){
            return redirect()->route('packages.index')->withSuccess(__('message.update_form',['form' => __('message.package')]));
        }
    ...
    public function destroy($id)
    {
        if(env('APP_DEMO')){
            ...
            return redirect()->route('packages.index')->withErrors($message);
        }
