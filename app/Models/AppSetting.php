...
class AppSetting extends Model implements HasMedia
{
    ...
    protected $fillable = [ 'site_name', 'site_email', 'site_description', 'site_copyright', 'facebook_url', 'twitter_url', 'linkedin_url' , 'language_option', 'contact_email', 'contact_number', 'address', 'instagram_url', 'help_support_url' ];
