                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="card-action">
                            <a href="{{ route('stretching.video.list') }}" class="btn btn-sm btn-primary" role="button">{{ __('message.back') }}</a>
                        </div>
                    </div>

                    <div class="card-body">
                        {!! Form::open(['route' => 'stretching.video.store', 'method' => 'post', 'files' => true]) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="form-control-label" for="video_url">Stretching Video File</label>
                                    <div>
