                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="card-action">
                            <a href="{{ route('stretching.video.create') }}" class="btn btn-sm btn-primary" role="button">Add Stretching Video</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @forelse($stretchingVideos as $index => $video)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{ $video->id }}"
                                                      action="{{ route('stretching.video.destroy', $video->id) }}"
                                                      method="POST"
                                                      style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
