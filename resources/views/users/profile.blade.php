    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-block">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title mb-0">{{ __('message.workout_history') }}</h4>
                    </div>
                </div>
                <div class="card-body">
                    {{ $exerciseDataTableHtml->table(['class' => 'table  w-100'],false) }}
                </div>
            </div>
        </div>
    </div>
