...
<x-app-layout :assets="$assets ?? []">
    <div>
        <?php $id = $id ?? null;?>
        @if(isset($id))
            {!! Form::model($data, [ 'route' => ['level.update', $id], 'method' => 'patch', 'enctype' => 'multipart/form-data' ]) !!}
        @else
            {!! Form::open(['route' => ['level.store'], 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
        @endif
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <!--<div class="form-group col-md-6">-->
                            <!--    {{ Form::label('rate', __('message.rate').' <span class="text-danger">*</span>',[ 'class' => 'form-control-label' ], false ) }}-->
                            <!--    {{ Form::number('rate', old('rate'),[ 'placeholder' => __('message.rate'),'class' =>'form-control','required']) }}-->
                            <!--</div>-->
                            <div class="form-group col-md-6">
